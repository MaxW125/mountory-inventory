      ...
      <div className="pt-4 border-t border-border mt-4 flex gap-2">
        <Button
          ...
          onClick={async () => {
            ...
            const unitCost = parseFloat(form.cost_per_unit || "0");
            ...
            try {
              ...
              setErrorMessage(
                getErrorMessage(error, "Could not save material right now.")
              );
            } finally {
        ...
        >
          ...
          {isSubmitting ? "Saving..." : mode === "create" ? "Create Material" : "Save Changes"}
        </Button>
